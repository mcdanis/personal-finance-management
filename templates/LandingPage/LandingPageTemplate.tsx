            ...
            <main>
                <Section>
                    <Container center className={styles.headerSection}>
                        ...
                        <Subtitle>
                            ...
                            <InlineCode>pages/index.tsx</InlineCode>
                        </Subtitle>
                    </Container>
                </Section>
                <Section>
                    <Container className={styles.textContainer}>
                        <H2>Final steps</H2>
                        <Paragraph>
                            There are a few final steps that we were not able to
                            perform automatically. We have provided a complete
                            list for you in the{' '}
                            <InlineCode>README.md</InlineCode> file. You should
                            take care of these before you can start developing
                            your project.
                        </Paragraph>
                    </Container>
                </Section>
                <Section>
                    <Container className={styles.technologyGridIntro}>
                        <H2>Technologies</H2>
                        <Paragraph>
                            Below you will find an overview of your chosen
                            technologies providing you helpful links and simple
