...
const TemplateCustomReport = ({ title = '', classType = '' }) => {
  return (
...
export const CustomExpenditureReport = () => {
  return <TemplateCustomReport title="Pengeluaran" classType="bg-yellow-100" />
};
export const CustomIncomeReport = () => {
  return <TemplateCustomReport title="Pemasukan" classType="bg-green-100" />
};
