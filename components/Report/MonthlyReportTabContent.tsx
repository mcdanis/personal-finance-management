        ...
        <div className="w-full md:w-2/2">
          ...
          <div className="text-right pb-3">
            <div className="relative text-center rounded-full px-3 py-1 text-sm/6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              ...
              : Rp20.000 - 23 Feb 2024 &nbsp;|&nbsp;&nbsp;
              <span className="font-bold">{title} Terkecil </span>: Rp20.000 -
              23 Feb 2024
            </div>
          </div>
          <div className="flex items-center max-w-md mb-5 ml-auto">
            ...
            <div className="relative w-full">
              ...
              <input
                type="text"
                id="search"
                className="block w-full pt-2 pb-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500"
                placeholder="Search..."
                required
              />
            </div>
...
export const MonthlyExpenditureReport = () => {
  return (
    <TemplateMonthlyReport title="Pengeluaran" classType="bg-yellow-100" />
  );
};
